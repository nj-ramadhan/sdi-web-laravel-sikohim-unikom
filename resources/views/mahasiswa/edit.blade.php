                ...
                <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                    <div class="col-span-12 card lg:col-span-6 2xl:col-span-6">
                        ...
                        <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ old('id', $mahasiswa->id) }}" placeholder="Masukkan NTA">
                    ...
                    <div class="col-span-12 card lg:col-span-6 2xl:col-span-6">
                        <div class="card-body">
                            <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="number" class="form-control @error('angkatan') is-invalid @enderror" name="angkatan" value="{{ old('angkatan', $mahasiswa->angkatan) }}" placeholder="Masukkan Tahun Angkatan">
                            ...
                            <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="text" class="form-control @error('divisi') is-invalid @enderror" name="divisi" value="{{ old('divisi', $mahasiswa->divisi) }}" placeholder="Masukkan Divisi">
                            ...
                            <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" value="{{ old('jabatan', $mahasiswa->jabatan) }}" placeholder="Masukkan Jabatan">
