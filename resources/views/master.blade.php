...
<body>
    <div class="container">
        ...
        <nav class="navbar navbar-default">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="{{route('actionlogout')}}"><i class="fa fa-power-off"></i> Log Keluar</a></li>
                  </ul>
                </li>
              </ul>
            </div><!-- /.navbar-collapse -->
          ...
          @yield('content')
          <div><a href="{{ route('mahasiswa.index') }}">MAHASISWA</a></div>
          <div><a href="{{ route('aspirasi.index') }}">ASPIRASI</a></div>
        </div>
        </div>        
    </div>
</body>
