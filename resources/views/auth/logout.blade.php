    ...
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <div class="mt-8 text-center">
                ...
                <h4 class="mb-2 text-custom-500 dark:text-custom-500">Kamu sudah keluar</h4>
                <p class="mb-8 text-slate-500 dark:text-zink-200">Terimakasih sudah menggunakan HIMA-SI</p>
            </div>
